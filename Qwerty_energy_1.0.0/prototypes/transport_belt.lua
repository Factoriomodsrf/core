...
-- Item
  {
    ...
    icon = "__X100_assembler__/graphics/icon/icon_5d_tbelt_5_.png",
    flags = {"goes-to-quickbar"},
    icon_size = 32,
    subgroup = "belt",
    order = "r",
    place_result = "transport_belt_X100",
    stack_size = 50
  },
...
--Entity
  {
    ...
    minable = {hardness = 0.2, mining_time = 0.3, result = "transport_belt_X100"},
    icon_size = 32,
    max_health = 50,
